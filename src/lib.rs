...
// Using global mutable state "goes against everything that Rust stands for..."
// "However, in our edge case, like providing a mutable state store for a
// WebAssembly module, it is pretty much the only way to make the module work."
lazy_static! {
